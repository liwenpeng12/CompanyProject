...
import com.liwenpeng.companyproject.util.LogUtils;
 ...
 * Descrobe:
 */
public class HnRequestLogInterceptor implements Interceptor { private static final Charset UTF8 = Charset.forName("UTF-8");
