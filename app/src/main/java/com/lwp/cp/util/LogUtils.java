 ...
 * 2018/6/30 23:00
 * CompanyProject
 * Descrobe:LEVEL = VERBOSE时打印所有调试信息 * 当项目上线时，改为 LEVEL = NOTHING * 关闭所有打印信息 * @author 81091 *
 */
        ...
        public static class Builder {
            ...
            public Builder() {
                if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                    dir = BaseApplication.getmContext().getExternalCacheDir() + File.separator + "log" + File.separator;
                } else {
                    dir = BaseApplication.getmContext().getCacheDir() + File.separator + "log" + File.separator;
                }
            }
